...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_future.cpp
LOCAL_MODULE := libhealthd.future
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_future_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := future_charger_res_images
LOCAL_MODULE_TAGS := optional
